        ...
        <div className="bg-[#BFCFBB] shadow-2xl py-24 sm:py-32">
            <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                ...
                <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-1">
                    <div className="lg:basis-1/3 md:basis-2/3 basis-10/12 sm:justify-items-center lg:justify-self-start">
                        <div className="relative mb-8 block cursor-pointer">
                            <Image 
                                ...
                                className="justify-self-center inset-0 transition duration-500 ease-in-out hover:h-[475px] hover:w-[375px]"
                                priority
                            />
                        ...
                        <div className="relative mb-8 block cursor-pointer">
                            <Image 
                                ...
                                className="justify-self-center inset-0 transition duration-500 ease-in-out hover:h-[355px] hover:w-[375px]"
                                priority
                            />
                            <div className="absolute left-1/2 transform -translate-x-1/2 bottom-5 w-44">
                                <Button className="flex justify-center items-center w-full">
                    ...
                    <div className="lg:basis-1/3 md:basis-2/3 basis-10/12 sm:justify-items-center lg:justify-self-center">
                        <div className="relative mb-8 block cursor-pointer">
                            <Image 
                                width={370}
                                height={350}
                    ...
                    <div className="lg:basis-1/3 md:basis-2/3 basis-10/12 sm:justify-items-center lg:justify-self-end">
                        <div className="relative mb-8 block cursor-pointer">
                            <Image 
                                width={370}
                                height={470}
